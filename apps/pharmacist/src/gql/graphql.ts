...
export type PharmacistMedicationDetailProductUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PharmacistMedicationDetailProductUpdatedSubscription = { __typename?: 'Subscription', medicinalProductUpdated: { __typename?: 'MedicinalProduct', id: string, productName: string, stockLevel: number, stockThreshold: number, isBelowThreshold: boolean } };
...
export const PharmacistMedicationDetailProductUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"PharmacistMedicationDetailProductUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"medicinalProductUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"productName"}},{"kind":"Field","name":{"kind":"Name","value":"stockLevel"}},{"kind":"Field","name":{"kind":"Name","value":"stockThreshold"}},{"kind":"Field","name":{"kind":"Name","value":"isBelowThreshold"}}]}}]}}]} as unknown as DocumentNode<PharmacistMedicationDetailProductUpdatedSubscription, PharmacistMedicationDetailProductUpdatedSubscriptionVariables>;
