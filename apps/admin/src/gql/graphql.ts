...
export type AdminOverviewQuery = { __typename?: 'Query', medicinalProducts: Array<{ __typename?: 'MedicinalProduct', id: string, productName: string, stockLevel: number, stockThreshold: number, isBelowThreshold: boolean, medication?: { __typename?: 'Medication', innName: string, atcCode: string, strength: string } | null }>, orders: Array<{ __typename?: 'Order', id: string, status: OrderStatus }> };

export type AdminOverviewProductUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type AdminOverviewProductUpdatedSubscription = { __typename?: 'Subscription', medicinalProductUpdated: { __typename?: 'MedicinalProduct', id: string, productName: string, stockLevel: number, stockThreshold: number, isBelowThreshold: boolean } };
...
export const AdminOverviewProductUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"AdminOverviewProductUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"medicinalProductUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"productName"}},{"kind":"Field","name":{"kind":"Name","value":"stockLevel"}},{"kind":"Field","name":{"kind":"Name","value":"stockThreshold"}},{"kind":"Field","name":{"kind":"Name","value":"isBelowThreshold"}}]}}]}}]} as unknown as DocumentNode<AdminOverviewProductUpdatedSubscription, AdminOverviewProductUpdatedSubscriptionVariables>;
