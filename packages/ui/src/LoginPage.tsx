        ...
        >
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-[var(--border-2)] bg-[var(--surface)] px-3 py-2 text-sm text-[var(--ink)] focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent"
              required
            >
              {actors.map((a) => (
